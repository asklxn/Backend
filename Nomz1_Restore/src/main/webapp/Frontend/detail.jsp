...
<%
  ...
  int productId = product.getProductId(); // ❗ getProductId() 필수
%>
<!DOCTYPE html>
<html lang="ko">
<head>
  ...
  <style>
    ...
    .cart_btn, .buy_btn { width: 270px; height: 100%; background-color: #0b1838; color: #fffdf9; font-size: 20px; text-align: center; line-height: 50px; cursor: pointer; }
  </style>
</head>
<body>
<header>
...
<section class="section_1">
  ...
  <div class="text_wrap">
    ...
    <form method="post" action="<%=request.getContextPath()%>/buy">
	  ...
	  <input type="hidden" name="price" value="<%= price %>"> <!-- ✅ 여기를 추가 -->
      ...
      <div class="btn_wrap">
        <div class="cart_btn" type="button">장바구니</div>
